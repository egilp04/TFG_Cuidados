export const week_days = [
  ...
  { valor: 'jueves', label: 'MANAGEMENT_SCHEDULES.DAYS.THURSDAY' },
  { valor: 'viernes', label: 'MANAGEMENT_SCHEDULES.DAYS.FRIDAY' },
  { valor: 'sabado', label: 'MANAGEMENT_SCHEDULES.DAYS.SATURDAY' },
...
export const tranlsate_days: { [key: string]: string } = {
  ...
  jueves: 'MANAGEMENT_SCHEDULES.DAYS.THURSDAY',
  viernes: 'MANAGEMENT_SCHEDULES.DAYS.FRIDAY',
